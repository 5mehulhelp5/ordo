...
use Ordo\Automation\Block\Adminhtml\WhatsAppTemplate\Edit\BackButton;
...
class BackButtonTest extends TestCase
{
    ...
    public function testGetButtonDataReturnsBackConfig(): void
    {
        ...
        $urlBuilder->method('getUrl')
            ->willReturnMap([['*/*/', [], 'https://example.com/admin/ordo/whatsapptemplate/']]);
        ...
        self::assertStringContainsString('whatsapptemplate', $data['on_click']);
    }
}
