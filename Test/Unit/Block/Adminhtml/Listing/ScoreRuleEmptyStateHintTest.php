...
use Ordo\Automation\Block\Adminhtml\Listing\ScoreRuleEmptyStateHint;
use Ordo\Automation\Model\ResourceModel\ScoreRule\Collection;
use Ordo\Automation\Model\ResourceModel\ScoreRule\CollectionFactory;
use PHPUnit\Framework\TestCase;

/**
 * getCollectionSize() is the only line ScoreRuleEmptyStateHint itself adds over its abstract
 ...
 */
class ScoreRuleEmptyStateHintTest extends TestCase
{
    ...
    private function makeBlock(CollectionFactory $collectionFactory): ScoreRuleEmptyStateHint
    {
        $context = $this->createStub(Context::class);

        return new ScoreRuleEmptyStateHint($context, $collectionFactory);
    }
