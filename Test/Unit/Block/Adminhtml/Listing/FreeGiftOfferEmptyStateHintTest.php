...
use Ordo\Automation\Block\Adminhtml\Listing\FreeGiftOfferEmptyStateHint;
...
/**
 * getCollectionSize() is the only line FreeGiftOfferEmptyStateHint itself adds over its abstract
 ...
 */
class FreeGiftOfferEmptyStateHintTest extends TestCase
{
    ...
    private function makeBlock(CollectionFactory $collectionFactory): FreeGiftOfferEmptyStateHint
    {
        $context = $this->createStub(Context::class);

        return new FreeGiftOfferEmptyStateHint($context, $collectionFactory);
    }
