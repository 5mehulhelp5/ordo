...
use Ordo\Automation\Block\Adminhtml\Listing\SegmentEmptyStateHint;
use Ordo\Automation\Model\ResourceModel\Segment\Collection;
use Ordo\Automation\Model\ResourceModel\Segment\CollectionFactory;
use PHPUnit\Framework\TestCase;

/**
 * getCollectionSize() is the only line SegmentEmptyStateHint itself adds over its abstract
 ...
 */
class SegmentEmptyStateHintTest extends TestCase
{
    ...
    private function makeBlock(CollectionFactory $collectionFactory): SegmentEmptyStateHint
    {
        $context = $this->createStub(Context::class);

        return new SegmentEmptyStateHint($context, $collectionFactory);
    }
