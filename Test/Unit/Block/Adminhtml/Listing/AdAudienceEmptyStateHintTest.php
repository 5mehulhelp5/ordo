...
use Ordo\Automation\Block\Adminhtml\Listing\AdAudienceEmptyStateHint;
use Ordo\Automation\Model\ResourceModel\AdAudience\Collection;
use Ordo\Automation\Model\ResourceModel\AdAudience\CollectionFactory;
use PHPUnit\Framework\TestCase;

/**
 * getCollectionSize() is the only line AdAudienceEmptyStateHint itself adds over its abstract
 ...
 */
class AdAudienceEmptyStateHintTest extends TestCase
{
    ...
    private function makeBlock(CollectionFactory $collectionFactory): AdAudienceEmptyStateHint
    {
        $context = $this->createStub(Context::class);

        return new AdAudienceEmptyStateHint($context, $collectionFactory);
    }
