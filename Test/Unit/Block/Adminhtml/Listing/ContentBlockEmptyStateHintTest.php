...
use Ordo\Automation\Block\Adminhtml\Listing\ContentBlockEmptyStateHint;
...
/**
 * getCollectionSize() is the only line ContentBlockEmptyStateHint itself adds over its abstract
 ...
 */
class ContentBlockEmptyStateHintTest extends TestCase
{
    ...
    private function makeBlock(CollectionFactory $collectionFactory): ContentBlockEmptyStateHint
    {
        $context = $this->createStub(Context::class);

        return new ContentBlockEmptyStateHint($context, $collectionFactory);
    }
