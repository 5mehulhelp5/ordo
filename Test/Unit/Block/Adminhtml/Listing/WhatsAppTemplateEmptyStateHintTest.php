...
use Ordo\Automation\Block\Adminhtml\Listing\WhatsAppTemplateEmptyStateHint;
use Ordo\Automation\Model\ResourceModel\WhatsAppTemplate\Collection;
use Ordo\Automation\Model\ResourceModel\WhatsAppTemplate\CollectionFactory;
use PHPUnit\Framework\TestCase;

/**
 * getCollectionSize() is the only line WhatsAppTemplateEmptyStateHint itself adds over its abstract
 ...
 */
class WhatsAppTemplateEmptyStateHintTest extends TestCase
{
    ...
    private function makeBlock(CollectionFactory $collectionFactory): WhatsAppTemplateEmptyStateHint
    {
        $context = $this->createStub(Context::class);

        return new WhatsAppTemplateEmptyStateHint($context, $collectionFactory);
    }
